...
|   类别   | 组件示例                       | 功能说明               | 图例                                                         |
| :------: | :----------------------------- | ---------------------- | ------------------------------------------------------------ |
| **渲染** | `MeshFilter`、`MeshRenderer`   | 显示模型               | <img src="Image/GameObjectCube.png" style=" width: 200px; margin-right: 10px;"/> |
| **物理** | `Rigidbody`、`Collider` 系列   | 物理运动、碰撞检测     |                                                              |
| **音频** | `AudioSource`、`AudioListener` | 播放声音、接收声音     | <img src="Image/Audio.png" style=" width: 200px; margin-right: 10px;"/> |
| **灯光** | `Light`                        | 提供光照               | <img src="Image/GameObjectLight.png" style=" width: 200px; margin-right: 10px;"/> |
...
| Shader           | 控制像素/顶点渲染逻辑，支持自定义视觉效果                    | <img src="Shader/Heartfelt.gif" style=" width: 200px; margin-right: 10px;"/><img src="Plugins/Painter.gif" style=" width: 200px; margin-right: 10px;"/> | <img src="Image/Shader1.gif" style=" width: 200px; margin-right: 10px;"/><img src="Image/Shader2.gif" style=" width: 200px; margin-right: 10px;"/> |
...
| 系统类型        | 引擎         | 用于         |
| --------------- | ------------ | ------------ |
| **3D 物理系统** | NVIDIA PhysX | 用于 3D 场景 |
| **2D 物理系统** | Box2D        | 用于 2D 场景 |
...
| Ray             | 物理检测、交互触发、拖拽功能     | <img src="Image/Ray.gif" style=" width: 300px; margin-right: 10px;" /> | <img src="Image/Ray1.gif" style=" width: 300px; margin-right: 10px;" /> |
| LineRenderer    | 路径绘制、书写绘画、图形绘制     | <img src="Image/LineRenerer1.gif" style=" width: 300px; margin-right: 10px;" /> | <img src="Image/LineRenderer2.gif" style=" width: 300px; margin-right: 10px;" /> |
